...
<section id="wrapper">
        ...
        <div class="login-register" style="background-color:#dedede;">
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="login-form" action="<?php echo base_url('auth/login'); ?>" method="post">
                    <h2 class="box-title m-b-40 text-center">Entrar em PET</h2>
